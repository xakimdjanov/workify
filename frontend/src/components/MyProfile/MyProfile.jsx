            ...
            <div className="bg-white rounded-[24px] p-6 shadow-sm relative border border-gray-50 text-center">
              ...
              <div className="relative inline-block mt-4">
                ...
                <button
                  ...
                  className="absolute bottom-1 right-1 bg-white p-2 rounded-full shadow-md text-gray-500 border border-gray-100 hover:bg-blue-500 hover:text-white transition"
                >
                  <FiCamera size={14} />
                </button>
                <input
              ...
              <div className="mt-1 text-gray-800 font-bold text-lg">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-[24px] p-8 shadow-sm relative border border-gray-50">
              <button
                ...
                className="absolute top-6 right-6 text-gray-400 hover:text-blue-500 transition"
              >
                <FiEdit2 size={18} />
              </button>
                ...
                <div className="flex flex-wrap gap-3">
                  {user?.skils?.length > 0 ? (
                    user.skils.map((s, i) => (
                      <span
                        key={i}
                        className="bg-[#F8F9FB] text-gray-600 px-4 py-2 rounded-lg text-sm border border-gray-100"
                      >
          ...
          <div className="bg-white rounded-[24px] w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="p-8 overflow-y-auto">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold uppercase tracking-tight text-gray-800">
                  Edit {activeModal}
                </h2>
                <button
                  onClick={() => setActiveModal(null)}
                  className="p-2 bg-gray-100 rounded-full text-gray-500 hover:bg-red-50 hover:text-red-500 transition"
                >
                  <FiX size={20} />
                </button>
              </div>
                      ...
                      {formData.skils?.map((s, i) => (
                        <div key={i} className="flex gap-2 mb-2">
                          <input
                            ...
                            className="flex-1 bg-gray-50 p-3 rounded-xl border border-gray-200 outline-none focus:border-emerald-500 transition"
                          />
                          <input
                            placeholder="Years"
                            ...
                            className="w-32 bg-gray-50 p-3 rounded-xl border border-gray-200 outline-none focus:border-emerald-500 transition"
                          />
                          <button
                            type="button"
                      ...
                      {formData.language?.map((l, i) => (
                        <div key={i} className="flex gap-2 mb-2">
                          <input
                            ...
                            className="flex-1 bg-gray-50 p-3 rounded-xl border border-gray-200 outline-none"
                          />
                          <select
                            value={l.level}
                            onChange={(e) =>
                            ...
                            className="bg-gray-50 p-3 rounded-xl border border-gray-200 outline-none"
                          >
