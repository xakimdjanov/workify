...
export default function JobDetail() {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Serverda xatolik yuz berdi (500)"
      );
    } finally {
  ...
  if (loading)
    return (
      <div className="text-center py-20 animate-pulse">Yuklanmoqda...</div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] p-4 md:p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-[#163D5C] font-bold mb-6"
        >
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-500 font-bold">
                  {job.company?.company_name || "TechCells"}
                </p>
