      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm mb-6">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-md font-black text-slate-800 mb-3 uppercase tracking-wider text-[13px]">
                What you will do:
              </h3>
        ...
        <div className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm">
          <h3 className="text-md font-black text-slate-800 mb-6 uppercase tracking-wider text-[13px]">
            About company
          </h3>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex gap-4 w-full lg:w-auto">
              ...
              <div className="overflow-hidden">
                <h4 className="text-md font-black text-slate-800 truncate">
                  {job.company?.company_name}
                </h4>
                <p className="text-gray-400 text-[11px] font-bold leading-tight uppercase truncate">
                  {job.company?.category || "Technology & Software"}
                </p>
                <p className="text-gray-400 text-[11px] font-bold mt-1 opacity-70 italic">
                  {job.location}
                </p>
              </div>
            </div>
